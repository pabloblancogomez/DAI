...
class dai:
    ...
    def dai_func_calc(self):    
        ...
        gdal.Warp(srcDSOrSrcDSTab=aerial_image_end,
                    ...
                    options=options) 
        # crop_tiff_2 = gdal.Open(dst_crop_end)
        ...
        # t1 = datetime.datetime.strptime('2022-06-14', '%Y-%m-%d')
        # t2 = datetime.datetime.strptime('2022-06-19', '%Y-%m-%d')
        ...
        for i in interval:
            ...
            data_red_dst_ds_interpolation = np.nan
            data_green_dst_ds_interpolation = np.nan
            data_blue_dst_ds_interpolation = np.nan
            ...
            dst_ds_interpolation.SetGeoTransform(crop_resample_1.GetGeoTransform())     
            dst_ds_interpolation.SetProjection(crop_resample_1.GetProjection())
